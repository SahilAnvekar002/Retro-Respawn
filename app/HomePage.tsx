...
export default function HomePage({ blogs }: PropsType) {
        ...
        <>
            ...
            <section className="py-14 sm:py-28" style={{ backgroundColor: 'rgb(246, 244, 255)' }}>
                ...
                <div className="flex lg:flex-row flex-col pt-36 sm:pt-52 lg:px-24 md:px-12 sm:pb-20 pb-10">
                    <div className="w-full lg:w-1/2 px-4 sm:px-10 transform translate-y-20 transition-[opacity,transform] duration-500 delay-500 sm:delay-300 opacity-0" ref={(el) => { refs.current[2] = el }}>
                        ...
                        <Link href="/service" className="text-blue-600 font-semibold text-lg flex items-center">Read more <IconArrowRight className="ml-1" style={{ marginTop: '2px' }} /></Link>
                    </div>
            ...
            <section className="py-12 sm:py-24">
                <div className="flex flex-col lg:px-24 md:px-12">
                    ...
                    <div className="px-4 sm:px-10 mt-6 transform translate-y-20 transition-[opacity,transform] duration-500 delay-500 opacity-0" ref={(el) => { refs.current[5] = el }}>
                        ...
                        <Link href="/about" className="text-blue-600 font-semibold text-lg flex items-center mt-6">Read more <IconArrowRight className="ml-1" style={{ marginTop: '2px' }} /></Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-24" style={{ backgroundColor: 'rgb(246, 244, 255)' }}>
                <div className="flex xl:flex-row flex-col lg:px-24 md:px-12">
                    <div className="flex flex-col self-start w-full lg:w-2/3 xl:w-1/2 px-4 sm:px-10 transform translate-y-20 transition-[opacity,transform] duration-500 delay-500 sm:delay-300 opacity-0 xl:sticky top-28 xl:mb-0 mb-6" ref={(el) => { refs.current[6] = el }}>
                    ...
                    <div className="flex flex-col w-full xl:w-1/2 px-4 sm:px-10 transform translate-y-20 transition-[opacity,transform] duration-700 delay-500 sm:delay-1000 opacity-0" ref={(el) => { refs.current[7] = el }}>
                                    ...
                                    return (
                                        <Link href={blog.url} target="_blank" className="flex h-20 bg-white rounded-xl shadow-md cursor-pointer mb-4" key={i}>
                                            <div className="w-[120px] sm:w-[200px] xl:w-[40%] h-full">
                                                <img src={blog.urlToImage} alt="" className="object-cover h-full w-full rounded-s-md hover:brightness-75 transition-all duration-300 ease-in-out" />
                                            </div>
                                            <div className="w-[60%]">
                                                <p className="xl:px-4 xl:py-4 sm:px-6 sm:py-6 px-3 py-3 text-xs text-slate-800 font-semibold">
                                                    {blog.description.length < 90 ? blog.description : blog.description.substring(0, 90) + '...'}</p>
                                            </div>
                                        </Link>
                                    )
                                }
            ...
            <section className="py-12 sm:py-24">
                <div className="flex justify-center items-center">
                    <div className="flex flex-col justify-center items-center md:w-[750px] xl:w-[850px] sm:px-10 px-6 md:px-0">
                        ...
                        <Link href='/contact' className="px-4 sm:px-6 py-1 sm:py-2 bg-blue-700 text-white rounded-lg text-lg font-semibold hover:bg-blue-800 transition-colors duration-300 ease-in-out">Contact Us</Link>
