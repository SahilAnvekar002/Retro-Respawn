...
export default function Home() {
  ...
  return (
    <>
      <section className="flex flex-col bg-fixed bg-cover h-[100vh] bg-home-bg lg:bg-left bg-right">
        <div className="flex flex-col md:px-24 xl:px-36 2xl:px-48 pt-56 transform translate-y-10 transition-[opacity,transform] duration-500 delay-300 opacity-0 md:items-start items-center" ref={(el) => { refs.current[0] = el }}>
      ...
      <section className="py-14 sm:py-28" style={{ backgroundColor: 'rgb(246, 244, 255)' }}>
        <div className="flex justify-center">
          <div className="flex flex-col items-center w-full px-4 sm:px-10 md:px-0 md:w-[700px] justify-center transform translate-y-10 transition-[opacity,transform] duration-500 delay-500 opacity-0" ref={(el) => { refs.current[1] = el }}>
        ...
        <div className="flex lg:flex-row flex-col pt-36 sm:pt-52 lg:px-24 md:px-12 sm:pb-20 pb-10">
          <div className="w-full lg:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-500 delay-300 opacity-0" ref={(el) => { refs.current[2] = el }}>
          ...
          <div className="lg:mt-0 mt-12 flex flex-col items-end w-full lg:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-700 delay-1000 opacity-0" ref={(el) => { refs.current[3] = el }}>
      ...
      <section className="py-12 sm:py-24">
        <div className="flex flex-col lg:px-24 md:px-12">
          <div className="px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-500 delay-500 opacity-0" ref={(el) => { refs.current[4] = el }}>
          ...
          <div className="px-4 sm:px-10 mt-6 transform translate-y-10 transition-[opacity,transform] duration-500 delay-500 opacity-0" ref={(el) => { refs.current[5] = el }}>
      ...
      <section className="py-12 sm:py-24" style={{ backgroundColor: 'rgb(246, 244, 255)' }}>
        <div className="flex xl:flex-row flex-col lg:px-24 md:px-12">
          <div className="flex flex-col self-start w-full lg:w-2/3 xl:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-500 delay-300 opacity-0 xl:sticky top-28 xl:mb-0 mb-6" ref={(el) => { refs.current[6] = el }}>
          ...
          <div className="flex flex-col w-full xl:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-700 delay-1000 opacity-0" ref={(el) => { refs.current[7] = el }}>
      ...
      <section className="py-12 sm:py-24">
        <div className="flex xl:flex-row flex-col-reverse xl:items-center justify-center lg:px-24 md:px-12">
          <div className="xl:block md:flex w-full xl:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-500 delay-500 opacity-0 overflow-x-hidden" ref={(el) => { refs.current[8] = el }}>
          ...
          <div className="w-full lg:w-2/3 xl:w-1/2 px-4 sm:px-10 transform translate-y-10 transition-[opacity,transform] duration-500 delay-500 opacity-0 xl:mb-0 sm:mb-12 mb-6" ref={(el) => { refs.current[9] = el }}>
