  ...
  return (
    <>
      <section className="flex flex-col lg:bg-fixed bg-cover sm:h-[100vh] bg-home-bg lg:bg-left bg-right">
        <div className="flex flex-col md:px-24 xl:px-36 2xl:px-48 pt-64 pb-72 sm:pb-0 sm:pt-56 transform translate-y-20 transition-[opacity,transform] duration-500 delay-300 opacity-0 md:items-start items-center" ref={(el) => { refs.current[0] = el }}>
